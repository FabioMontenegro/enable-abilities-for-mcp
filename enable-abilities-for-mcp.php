...
register_activation_hook(__FILE__, function () {
    if (get_option(EWPA_OPTION_KEY) === false) {
 ...
 */
function ewpa_get_abilities_registry(): array
{
    return array(
        'core' => array(
 ...
 */
function ewpa_get_all_ability_keys(): array
{
    $keys = array();
 ...
 */
function ewpa_is_ability_enabled(string $ability_key): bool
{
